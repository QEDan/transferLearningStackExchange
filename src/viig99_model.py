# Modified version Copy-and-pasted from https://github.com/viig99/stackexchange-transfer-learning
# Distributed under the Apache 2.0 license
# https://github.com/viig99/stackexchange-transfer-learning/blob/master/LICENSE
...
if __name__ == '__main__':
    ...
    # 
    test = returnConcatDataFrame('/home/mazur/Documents/transferLearningStackExchange/data/')
    ...
    EMBEDDING_DIM = 100
    GLOVE_DIR = "/home/mazur/Documents/transferLearningStackExchange/glove/" 
    STACKEXCHANGE_DIR = GLOVE_DIR + "/stackexchange"

    #TODO: Are these the same pickles as above?
    dataframe = training #pd.read_pickle(STACKEXCHANGE_DIR + "/pickle/training_physics.pkl")
    dataframe_test = test #pd.read_pickle(STACKEXCHANGE_DIR + "/pickle/testing.pkl")
